    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "restore MVFC.Mediator.slnx");
    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "build MVFC.Mediator.slnx --configuration Release --no-restore");
...
Task("Test-Coverage")
    ...
    .Does(() =>
{
    var testProject = "./tests/MVFC.Mediator.Tests/MVFC.Mediator.Tests.csproj";
    ...
    var rgCode = StartProcess(rgPath, $"-reports:\"{reportArgs}\" -targetdir:\"{reportDir}\" -reporttypes:\"Html;Cobertura;MarkdownSummaryGithub\" -assemblyfilters:\"+MVFC.Mediator*\" -classfilters:\"-*.Tests.*;-*.Playground.*\"");
